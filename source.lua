...
do
    ...
    do
        ...
        function types.window(name, options)
            ...
            table.insert(library.queue, { w = window.object; p = window.object.Position; })
            newWindow:FindFirstChild("window_toggle").MouseButton1Click:connect(function()
                ...
                local targetSize = window.toggled and UDim2.new(1, 0, 0, y+8) or UDim2.new(1, 0, 0, 0);
        ...
        function types:Resize()
            ...
            self.container.Size = UDim2.new(1, 0, 0, y+8)
        end
        ...
        function types:Bind(name, options, callback)
            ...
            local shortNames = { RightControl = 'RightCtrl'; LeftControl = 'LeftCtrl'; LeftShift = 'LShift'; RightShift = 'RShift'; MouseButton1 = "Mouse1"; MouseButton2 = "Mouse2"; }
        ...
        function types:Slider(name, options, callback)
            ...
            self:Resize();
            return { Set = function(self, value)
    ...
    function library:Create(class, data)
        ...
        -- Modern rounded corners for all relevant GUI elements
        if class == "Frame" or class == "TextButton" or class == "TextBox" or class == "ScrollingFrame" then
            local corner = Instance.new("UICorner")
            corner.CornerRadius = UDim.new(0, 8)
            corner.Parent = obj
        end
        -- Subtle stroke for modern border feel
        if (class == "Frame" or class == "TextButton" or class == "TextBox" or class == "ScrollingFrame") and data.BorderSizePixel ~= 0 then
            local stroke = Instance.new("UIStroke")
            stroke.Color = library.options.bordercolor
            stroke.Thickness = 1
    ...
    defaults = {
        ...
        boxcolor = Color3.fromRGB(22, 22, 22);
        btncolor = Color3.fromRGB(28, 28, 28);
